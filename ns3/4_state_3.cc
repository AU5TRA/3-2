                                         ...
                                         double& p22) const
{
    ...
    p11 = w1 * (m_p[1][1] + m_p[1][2]) + w2 * (m_p[2][1] + m_p[2][2]);
...
{
    int oldState = GetState(_old_ave);
    int newState = GetState(new_ave);

    m_n[oldState][newState] += 1.0;
