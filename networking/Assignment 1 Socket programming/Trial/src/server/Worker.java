    ...
    public void run()
    {
        ...
        while(true){
            ...
            if (obj instanceof Request){
                ...
                System.out.print(Color.YELLOW + client_name + Color.RESET + " requests: ");
                ...
                if(((Request)obj).request.equals(Request.LIST_ALL_CLIENTS)){
                    ...
                    System.out.println("Downloading own file.");
                    ...
                    System.out.println("Downloading public files.");
                    String fileName = (String)((Request)obj).getData();
                    server.prepare_public_file_download(client_name, socket, fileName);
                }
                    ...
                    System.out.println("File Request with request ID: " + file_request.requestID);
                    ...
                    System.out.println("Upload and download history");
